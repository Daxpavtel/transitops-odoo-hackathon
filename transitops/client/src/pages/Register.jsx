      ...
      <div className="max-w-md w-full bg-white rounded-2xl shadow-xl border border-slate-100 overflow-hidden">
        <div className="bg-slate-900 p-8 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <h1 className="text-3xl font-bold text-white tracking-tight mb-2">Join TransitOps</h1>
            <p className="text-slate-400 font-medium">Create your operations account</p>
          </div>
        </div>
        ...
        <div className="p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`w-full bg-slate-50 border ${errors.name ? 'border-red-300 focus:ring-red-500' : 'border-slate-200 focus:ring-indigo-500'} rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 transition-all`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`w-full bg-slate-50 border ${errors.email ? 'border-red-300 focus:ring-red-500' : 'border-slate-200 focus:ring-indigo-500'} rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 transition-all`}
            ...
            <div>
              ...
              <div className="relative">
                ...
                <select 
                  ...
                  className={`w-full bg-slate-50 border ${errors.role ? 'border-red-300 focus:ring-red-500' : 'border-slate-200 focus:ring-indigo-500'} rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 transition-all appearance-none`}
                  required
                >
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`w-full bg-slate-50 border ${errors.password ? 'border-red-300 focus:ring-red-500' : 'border-slate-200 focus:ring-indigo-500'} rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 transition-all`}
              ...
              <div className="mt-2 flex items-center justify-between">
                ...
                <span className={`text-[10px] font-bold uppercase tracking-wider ${formData.password.length === 0 ? 'text-slate-400' : passwordStrength.score === 4 ? 'text-emerald-600' : passwordStrength.score >= 2 ? 'text-amber-600' : 'text-red-600'}`}>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input 
                  ...
                  className={`w-full bg-slate-50 border ${errors.confirmPassword ? 'border-red-300 focus:ring-red-500' : 'border-slate-200 focus:ring-indigo-500'} rounded-xl pl-10 pr-4 py-2.5 text-sm focus:outline-none focus:ring-2 transition-all`}
            ...
            <button 
              type="submit" 
              disabled={loading}
              className="w-full bg-indigo-600 hover:bg-indigo-700 disabled:bg-indigo-400 text-white font-semibold py-3 px-4 rounded-xl shadow-md shadow-indigo-600/20 transition-all flex items-center justify-center gap-2 mt-6"
            >
